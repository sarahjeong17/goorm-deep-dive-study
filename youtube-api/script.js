// YouTube API 키
const API_KEY = "AIzaSyCzeZX-_nluWftQal-QZZZ1Z9w2zlX5598";
...
// 사이드바 이벤트 설정
const setupSidebarEvents = function () {
  ...
  videoCard.innerHTML = `
        <a href="https://www.youtube.com/watch?v=${videoId}" class="video-link" target="_blank">
            <div class="thumbnail-container">
              <img class="thumbnail" src="${thumbnailUrl}" alt="${title} 썸네일" />
            </div>
...
function getDummyVideoData() {
  return [
    ...
    {
      title: "CSS 레이아웃 테크닉: Flex box와 Grid 완벽 가이드",
      channel: "CSS 마법사",
      views: "9.3만회",
      date: "3주 전",
    },
...
function createDummyVideoCard(data, index, container) {
  ...
  videoCard.innerHTML = `
        <a href="#" class="video-link">
          <div class="thumbnail-container">
             <img class="thumbnail" alt="${data.title}" />${index + 1}</div>
            <div class="video-info">
